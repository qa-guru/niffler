...
export type Mutation = {
  ...
  fcmToken?: Maybe<Scalars['Void']['output']>;
  friendship: User;
  spend: Spend;
  user: User;
};
...
export type UpdateCategoryMutation = { __typename?: 'Mutation', category: { __typename?: 'Category', id: string, name: string, archived: boolean } };

export type FcmTokenMutationVariables = Exact<{
  input: FcmTokenInput;
}>;


export type FcmTokenMutation = { __typename?: 'Mutation', fcmToken?: any | null };
...
export type UpdateSpendMutation = { __typename?: 'Mutation', spend: { __typename?: 'Spend', id: string, spendDate: any, currency: CurrencyValues, amount: number, description?: string | null, category: { __typename?: 'Category', id: string, name: string, archived: boolean } } };
...
export type UpdateUserMutation = { __typename?: 'Mutation', user: { __typename?: 'User', id: string, username: string, fullname?: string | null, photo?: string | null } };
...
export type UpdateFriendshipStatusMutation = { __typename?: 'Mutation', friendship: { __typename?: 'User', id: string, username: string, fullname?: string | null, photo?: string | null } };

export type CurrenciesQueryVariables = Exact<{ [key: string]: never; }>;


export type CurrenciesQuery = { __typename?: 'Query', currencies: Array<{ __typename?: 'Currency', currency: CurrencyValues }> };
...
export type SpendsQuery = { __typename?: 'Query', spends?: { __typename?: 'SpendConnection', edges: Array<{ __typename?: 'SpendEdge', node: { __typename?: 'Spend', id: string, spendDate: any, currency: CurrencyValues, amount: number, description?: string | null, category: { __typename?: 'Category', id: string, name: string } } } | null>, pageInfo: { __typename?: 'PageInfo', hasPreviousPage: boolean, hasNextPage: boolean } } | null };
...
export type StatQuery = { __typename?: 'Query', stat: { __typename?: 'Statistic', total: number, currency: CurrencyValues, statByCategories: Array<{ __typename?: 'SumByCategory', categoryName: string, currency: CurrencyValues, sum: number, firstSpendDate: any, lastSpendDate: any }> } };

export type CurrentUserQueryVariables = Exact<{ [key: string]: never; }>;


export type CurrentUserQuery = { __typename?: 'Query', user: { __typename?: 'User', id: string, username: string, fullname?: string | null, photo?: string | null, categories: Array<{ __typename?: 'Category', id: string, name: string, archived: boolean }> } };
...
export type AllPeopleQuery = { __typename?: 'Query', allPeople?: { __typename?: 'UserConnection', edges: Array<{ __typename?: 'UserEdge', node: { __typename?: 'User', id: string, username: string, photoSmall?: string | null, fullname?: string | null, friendshipStatus?: FriendshipStatus | null } } | null>, pageInfo: { __typename?: 'PageInfo', hasPreviousPage: boolean, hasNextPage: boolean } } | null };
...
export const FcmTokenDocument = gql`
    mutation FcmToken($input: FcmTokenInput!) {
  fcmToken(input: $input)
}
    `;
export type FcmTokenMutationFn = Apollo.MutationFunction<FcmTokenMutation, FcmTokenMutationVariables>;

/**
 * __useFcmTokenMutation__
 *
 * To run a mutation, you first call `useFcmTokenMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useFcmTokenMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [fcmTokenMutation, { data, loading, error }] = useFcmTokenMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useFcmTokenMutation(baseOptions?: Apollo.MutationHookOptions<FcmTokenMutation, FcmTokenMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<FcmTokenMutation, FcmTokenMutationVariables>(FcmTokenDocument, options);
      }
export type FcmTokenMutationHookResult = ReturnType<typeof useFcmTokenMutation>;
export type FcmTokenMutationResult = Apollo.MutationResult<FcmTokenMutation>;
export type FcmTokenMutationOptions = Apollo.BaseMutationOptions<FcmTokenMutation, FcmTokenMutationVariables>;
 ...
 * });
 */
export function useSpendsQuery(baseOptions: Apollo.QueryHookOptions<SpendsQuery, SpendsQueryVariables> & ({ variables: SpendsQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
 ...
 * });
 */
export function useSpendQuery(baseOptions: Apollo.QueryHookOptions<SpendQuery, SpendQueryVariables> & ({ variables: SpendQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
 ...
 * });
 */
export function useAllPeopleQuery(baseOptions: Apollo.QueryHookOptions<AllPeopleQuery, AllPeopleQueryVariables> & ({ variables: AllPeopleQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
