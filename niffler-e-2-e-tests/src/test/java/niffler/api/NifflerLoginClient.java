...
public class NifflerLoginClient {
    ...
    private final Retrofit retrofit = new Retrofit.Builder()
            ...
            .baseUrl(NifflerLoginApi.nifflerAuthUri)
            .build();
    ...
    public void preAuthorize() throws Exception {
        ...
        nifflerAuthApi.preAuthorize(
                "code",
                "client",
                "openid",
                  NifflerLoginApi.nifflerFrontUri + "authorized",
                SessionStorage.getInstance().getCodeChallenge(),
                "S256"
                ).execute();
    }

    public Response<Void> login(String jSessionId, String xsrf, String username, String password) throws Exception {
