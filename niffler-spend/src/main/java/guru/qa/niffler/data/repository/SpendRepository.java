...
public interface SpendRepository extends JpaRepository<SpendEntity, UUID> {
  ...
  @Nonnull
  List<SpendEntity> findAllByUsernameOrderBySpendDateDesc(@Nonnull String username);

  @Nonnull
  Page<SpendEntity> findAllByUsernameOrderBySpendDateDesc(
      @Nonnull String username,
      @Nonnull Pageable pageable
  );

  @Nonnull
  List<SpendEntity> findAllByUsernameAndSpendDateGreaterThanEqualOrderBySpendDateDesc(
      @Nonnull String username,
      @Nonnull Date dateFrom
  );

  @Nonnull
  List<SpendEntity> findAllByUsernameAndCurrencyAndSpendDateGreaterThanEqualOrderBySpendDateDesc(
      @Nonnull String username,
  ...
  @Nonnull
  Page<SpendEntity> findAllByUsernameAndSpendDateGreaterThanEqualOrderBySpendDateDesc(
      @Nonnull String username,
      @Nonnull Date dateFrom,
      @Nonnull Pageable pageable
  );
  ...
  @Nonnull
  Page<SpendEntity> findAllByUsernameAndCurrencyAndSpendDateGreaterThanEqualOrderBySpendDateDesc(
      @Nonnull String username,
      @Nonnull CurrencyValues currency,
      @Nonnull Date dateFrom,
      @Nonnull Pageable pageable
  ...
  @Nonnull
  List<SpendEntity> findAllByUsernameAndSpendDateLessThanEqualOrderBySpendDateDesc(
      @Nonnull String username,
      @Nonnull Date dateTo
  );

  @Nonnull
  List<SpendEntity> findAllByUsernameAndCurrencyAndSpendDateLessThanEqualOrderBySpendDateDesc(
      @Nonnull String username,
      @Nonnull CurrencyValues currency,
      @Nonnull Date dateTo
  );
  ...
  @Nonnull
  Page<SpendEntity> findAllByUsernameAndSpendDateLessThanEqualOrderBySpendDateDesc(
      @Nonnull String username,
      @Nonnull Date dateTo,
      @Nonnull Pageable pageable
  );
  ...
  @Nonnull
  Page<SpendEntity> findAllByUsernameAndCurrencyAndSpendDateLessThanEqualOrderBySpendDateDesc(
      @Nonnull String username,
      @Nonnull CurrencyValues currency,
      @Nonnull Date dateTo,
      @Nonnull Pageable pageable
