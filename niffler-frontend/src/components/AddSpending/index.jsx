...
export const AddSpending = ({categories, addSpendingCallback}) => {
    ...
    return (
        <section className={"main-content__section main-content__section-add-spending"}>
                ...
                <form onSubmit={handleAddSpendingSubmit}>
                        <FormSelect label="Category" placeholder={"Choose spending category"} options={categories} value={data.category} onChange={(category) => {
